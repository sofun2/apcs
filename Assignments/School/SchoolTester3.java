...
public class SchoolTester3
{
    public static void main(String[] args)
    {
        ...
        ArrayList<Course> impacted = phhs.getImpactedCourseList(4);  //we want of arraylist of courses with 4 or more students
        for (int i = 0; i < impacted.size(); i++)
        {
            System.out.println("Impacted schools.");
            System.out.println(impacted.get(i).getName());
        }
